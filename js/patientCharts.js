...
myApp.charts = function () {
    this.BuildRefreshBg = function p0BuildRefreshBg() {
...
function p0BuildRefreshBg(renderTo) {

    DailyBgEventWithAverage = new Highcharts.Chart({
        chart: {
            renderTo: "bg" + renderTo
        },
        title: {
